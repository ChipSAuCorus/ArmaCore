 ...
 * @version 1.2
 */
public class RegisterCommands extends BukkitCommand {
     ...
     */
    public RegisterCommands(String name, CommandExecutor executor, JavaPlugin plugin) {
        super(name);
     ...
     * @param plugin      {@link JavaPlugin} that own the command
     */
    public RegisterCommands(String name, String usage, String description, String permission, List<String> aliases, CommandExecutor executor, JavaPlugin plugin) {
